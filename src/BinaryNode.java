class BinaryNode<T>
{
   ...
   private static <T> void postorderTraverse(BinaryNode<T> node) {
	    if (node != null) {
   ...
   int getHeight(BinaryNode<T> binaryNode) {
	    
	    if (binaryNode == null) {
	        return 0;
	    } else {
	   
	        int leftHeight = getHeight(binaryNode.getLeftChild());
	        int rightHeight = getHeight(binaryNode.getRightChild());
